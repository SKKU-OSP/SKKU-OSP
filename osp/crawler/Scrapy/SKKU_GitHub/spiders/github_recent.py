...
class GithubOverviewSpider(scrapy.Spider):
    ...
    def parse_user(self, res) :
        ...
        logging.info(f"parse_user: created_date {created_date}, end_date {updated_date},  recent_date {recent_date}")
        ...
        logging.info(f"parse_user: {github_id} updated_datetime {updated_datetime}")
